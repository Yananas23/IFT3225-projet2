...
Ces modèles permettent de d'afficher dynamiquement l'application one-page dans un navigateur web en utilisant les chemins de la section D en localhost lorsque l'application node.js est lancée.
